 ...
 10 open 1,"examples/test_fileIO/test_files/test_append.txt,s,r"
 30 gosub 310
 50 close 1
 55 print "File was read!"
 60 REM AppendFileContent
 65 open 1,"examples/test_fileIO/test_files/test_append.txt,s,a"
...
170 d$ = s$ + d$ + "\n" : REM Set the last "\n" == EOF at back
180 open 1,"examples/test_fileIO/test_files/test_append.txt,s,r"
190 gosub 310
200 close 1
