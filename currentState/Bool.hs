...
evalBoolExpression (BoolExprNum (numExpr1,numExpr2) strOp) state = 
    let 
       (val1,nstate1) = runStateT (evalExpression numExpr1) state 
       (val2,nstate2) = runStateT (evalExpression numExpr2) nstate1
...
--evalBoolExpression :: BoolExpr -> StateT ProgramState IO Bool
